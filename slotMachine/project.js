// 1. Deposit amount
// 2. Determine number of line to bet in 
...
for (let i = 0; i < COLS; i++) {
    ...
    for (let j = 0; j < ROWS; j++) {
        ...
        const selected = reelSymbols.splice(randomIndex, 1)[0];
...
const getNumberOfLines = () => 
    ...
    if (isNaN(numberoflines) || numberoflines <= 0 || numberoflines > 3) {
        console.log("Invalid bet lines, please try again.");
       } else {
...
const game = () =>{
    ...
    const getWinning = getWinnings(rows, bet , betLines)

    console.log(" You won $", + getWinning.toString())
